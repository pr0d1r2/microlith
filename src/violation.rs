...
/// cannot grep for.
pub const NAMESPACE: &str = "microlith";

impl fmt::Display for Violation {
    /// `microlith/V13: msg` -- the rule id QUALIFIED, and no coordinates.
    ///
    ...
    /// composes them; this prints only what microlith owns.
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
mod tests {
    ...
    fn the_rule_id_is_namespaced() {
        ...
        assert_eq!(v.to_string(), "microlith/V11: missing section");
    }
    ...
    fn a_bare_id_never_reaches_the_output() {
        ...
        let out = v.to_string();
        assert!(out.starts_with("microlith/V13: "), "{out}");
